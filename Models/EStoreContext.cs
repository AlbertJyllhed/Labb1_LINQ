...
{
    internal class EStoreContext : DbContext
    {
        ...
        private static void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>().HasData(
                new Order { Id = 1, OrderDate = new DateTime(2026, 03, 01), CustomerId = 1, TotalAmount = 11999, Status = "Levererad" },
                new Order { Id = 2, OrderDate = new DateTime(2026, 03, 05), CustomerId = 2, TotalAmount = 9695, Status = "Levererad" },
                new Order { Id = 3, OrderDate = new DateTime(2026, 03, 10), CustomerId = 3, TotalAmount = 18999, Status = "Behandlas" },
                new Order { Id = 4, OrderDate = new DateTime(2026, 03, 12), CustomerId = 4, TotalAmount = 3499, Status = "Levererad" },
                new Order { Id = 5, OrderDate = new DateTime(2026, 03, 15), CustomerId = 5, TotalAmount = 17494, Status = "Skickad" },
                new Order { Id = 6, OrderDate = new DateTime(2026, 02, 20), CustomerId = 1, TotalAmount = 899, Status = "Levererad" },
                new Order { Id = 7, OrderDate = new DateTime(2026, 02, 25), CustomerId = 3, TotalAmount = 2546, Status = "Levererad" },
                new Order { Id = 8, OrderDate = new DateTime(2026, 03, 18), CustomerId = 2, TotalAmount = 3496, Status = "Skickad" },
                new Order { Id = 9, OrderDate = new DateTime(2026, 03, 20), CustomerId = 4, TotalAmount = 11896, Status = "Behandlas" },
                new Order { Id = 10, OrderDate = new DateTime(2026, 03, 22), CustomerId = 5, TotalAmount = 1299, Status = "Behandlas" }
            );
